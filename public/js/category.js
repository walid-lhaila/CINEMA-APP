                            ...
                            <div class="p-5 flex justify-between items-center">
                                <div>
                                    ...
                                    <div class="flex gap-2 justify-center  items-center text-center mt-3">
                                        <svg class="updateCategory w-8 h-8  cursor-pointer hover:text-blue-500 duration-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
