        ...
        <div class="flex flex-wrap gap-5">
            ...
            <div class="card relative py-2">
                <div class="cursor-pointer  duration-700">
                    <img class="w-[330px] h-[240px]" src="{{url('img/tennis.jpg')}}" alt="">
                </div>
                <div class="bg-white shadow-lg w-[93%] mx-auto mt-[-20px] relative">
                    <div class="px-8 py-6">
                        <h1 class="text-lg text-black font-bold font-mono">The Way Of Water</h1>
                        <div class="py-2 flex gap-3">
                            <div class="flex items-center gap-1">
                                ...
                                <p class="text-xs text-gray-500">Sport</p>
                            </div>
                            <div class="flex items-center gap-1">
                                <svg class="w-4 h-4 text-orange-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v4a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8Z" clip-rule="evenodd"/>
                                </svg>
                                <p class="text-xs text-gray-500">180 Mins</p>
                            </div>
                        </div>
                        <div class="flex gap-3 mt-1">
                            <button class="text-gray-500 bg-gray-200 text-sm px-3 py-1 hover:text-white hover:bg-orange-500 duration-500 font-medium">Détails</button>
            ...
            <div class="card relative py-2">
                <div class="cursor-pointer  duration-700">
                    <img class="w-[330px] h-[240px]" src="{{url('img/sport2.jpg')}}" alt="">
                </div>
                <div class="bg-white shadow-lg w-[93%] mx-auto mt-[-20px] relative">
                    <div class="px-8 py-6">
                        <h1 class="text-lg text-black font-bold font-mono">The Way Of Water</h1>
            ...
            <div class="card relative py-2">
                <div class="cursor-pointer  duration-700">
                    <img class="w-[330px] h-[240px]" src="{{url('img/sport3.jpg')}}" alt="">
                </div>
                <div class="bg-white shadow-lg w-[93%] mx-auto mt-[-20px] relative">
                    <div class="px-8 py-6">
                        <h1 class="text-lg text-black font-bold font-mono">The Way Of Water</h1>
            ...
            <div class="card relative py-2">
                <div class="cursor-pointer  duration-700">
                    <img class="w-[330px] h-[240px]" src="{{url('img/sport4.jpg')}}" alt="">
                </div>
                <div class="bg-white shadow-lg w-[93%] mx-auto mt-[-20px] relative">
                    <div class="px-8 py-6">
                        <h1 class="text-lg text-black font-bold font-mono">The Way Of Water</h1>
            ...
            <div class="card relative py-2">
                <div class="cursor-pointer  duration-700">
                    <img class="w-[330px] h-[240px]" src="{{url('img/sport5.jpg')}}" alt="">
                </div>
                <div class="bg-white shadow-lg w-[93%] mx-auto mt-[-20px] relative">
                    <div class="px-8 py-6">
                        <h1 class="text-lg text-black font-bold font-mono">The Way Of Water</h1>
            ...
            <div class="card relative py-2">
                <div class="cursor-pointer  duration-700">
                    <img class="w-[330px] h-[240px]" src="{{url('img/natation.jpg')}}" alt="">
                </div>
                <div class="bg-white shadow-lg w-[93%] mx-auto mt-[-20px] relative">
                    <div class="px-8 py-6">
                        <h1 class="text-lg text-black font-bold font-mono">The Way Of Water</h1>
