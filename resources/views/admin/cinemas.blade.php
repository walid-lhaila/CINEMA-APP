...
<div class="flex relative">
    ...
    <div id="form" class="absolute bg-black w-full scale-0 opacity-100 h-screen ">
    ...
    <aside class="flex flex-col w-[320px] h-screen overflow-x-hidden overflow-y-auto bg-black border-r rtl:border-r-0 rtl:border-l  dark:border-gray-700">
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-300 hover:text-orange-500 transition-colors duration-300  rounded-lg " href="login">
                    <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    <section class="p-5 bg-black w-full">
        <div class="flex justify-between items-center text-center ">
            <div class="flex gap-3 text-center items-center ">
                ...
                <h1 class="text-3xl text-white font-bold font-mono">Cinemas</h1>
            </div>
            <button id="btn" class="text-white bg-orange-500 hover:bg-orange-600 font-bold text-sm px-3 py-2 rounded-lg duration-500">Add Cinema</button>
        </div>
